        ...
        <div className="flex items-center gap-3 md:gap-4">
          <div
            ...
            style={{
              ...
              boxShadow: '0 4px 14px rgba(229, 0, 18, 0.4)',
            }}
          >
            <Bot
...
function SignalSourceModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div
        className="rounded-lg p-6 w-full max-w-lg relative shadow-2xl"
        style={{ background: 'var(--background)', border: '1px solid #E0E0E0' }}
      >
        <h3
                    ...
                    {selectedExchange.id === 'binance' && (
                      ...
                      >
                        ...
                        {showBinanceGuide && (
                          ...
                          >
                            <p className="mb-2" style={{ color: '#424242' }}>
