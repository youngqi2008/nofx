        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center justify-between flex-1 ml-8">
              ...
              {isLoggedIn ? (
                ...
                <>
                  <button
                    ...
                    className="text-sm font-bold transition-all duration-300 relative focus:outline-2 focus:outline-red-500"
                    style={{
                      color:
            ...
            <div className="flex items-center gap-6">
              ...
              {/* Language Toggle - Hidden (language is fixed to Chinese) */}
              <div
                className="relative"
                ref={dropdownRef}
                style={{ display: 'none' }}
        ...
        <div className="px-4 py-4 space-y-3">
          ...
          {isLoggedIn ? (
            <button
              ...
              className="block text-sm font-bold transition-all duration-300 relative focus:outline-2 focus:outline-red-500"
              style={{
                color:
                  currentPage === 'competition'
                    ? 'var(--brand-red)'
