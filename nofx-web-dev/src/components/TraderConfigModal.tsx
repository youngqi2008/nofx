...
export function TraderConfigModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
      <div
        className="bg-white border border-[#E0E0E0] rounded-xl shadow-2xl max-w-3xl w-full mx-4 max-h-[90vh] overflow-y-auto"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-[#E0E0E0] bg-gradient-to-r from-[#F5F5F5] to-[#FAFAFA]">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#E50012] to-[#C40010] flex items-center justify-center">
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-lg text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[#E0E0E0] transition-colors flex items-center justify-center"
          >
            ✕
          </button>
        </div>
        ...
        <div className="p-6 space-y-8">
          {/* Basic Info */}
          <div className="bg-[#F5F5F5] border border-[#E0E0E0] rounded-lg p-5">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-white border border-[#E0E0E0] rounded text-[var(--text-primary)] focus:border-[var(--brand-red)] focus:outline-none"
                    ...
                    <button
                      ...
                      className={`flex-1 px-3 py-2 rounded text-sm ${
                        formData.is_cross_margin
                          ...
                          : 'bg-white text-[var(--text-secondary)] border border-[#E0E0E0]'
                      }`}
                    >
                      全仓
                    </button>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="text-sm text-[var(--text-primary)]">
                      初始余额 ($)
                      {!isEditMode && (
                        <span className="text-[var(--brand-red)] ml-1">*</span>
                      )}
                    </label>
                    {isEditMode && (
                      <button
                        ...
                        className="px-3 py-1 text-xs bg-[var(--brand-red)] text-white rounded hover:bg-[var(--brand-red-dark)] transition-colors disabled:bg-[var(--text-secondary)] disabled:cursor-not-allowed"
                      >
                  ...
                  />
                  {!isEditMode && (
                    <p className="text-xs text-[var(--brand-red)] mt-1 flex items-center gap-1">
                      <svg
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    ...
                    className="px-3 py-1 text-xs bg-[var(--brand-red)] text-white rounded hover:bg-[var(--brand-red-dark)] transition-colors"
                  >
                ...
                {/* 币种选择器 */}
                {showCoinSelector && (
                  <div className="mt-3 p-3 bg-white border border-[#E0E0E0] rounded">
                        ...
                        <button
                          ...
                          className={`px-2 py-1 text-xs rounded transition-colors ${
                            selectedCoins.includes(coin)
                              ? 'bg-[var(--brand-red)] text-white'
                              : 'bg-white text-[var(--text-secondary)] border border-[#E0E0E0] hover:border-[var(--brand-red)]'
                          }`}
                        >
                          {coin.replace('USDT', '')}
                        </button>
          ...
          <div className="bg-[#F5F5F5] border border-[#E0E0E0] rounded-lg p-5">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div
                  ...
                  style={{
                    ...
                    border: '1px solid rgba(229, 0, 18, 0.15)',
                  }}
                >
                  <div
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-[var(--brand-red)] inline-flex items-center gap-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-3.5 h-3.5"
                    viewBox="0 0 24 24"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 bg-white border border-[#E0E0E0] rounded text-[var(--text-primary)] focus:border-[var(--brand-red)] focus:outline-none h-24 resize-none"
                  placeholder={
                    formData.override_base_prompt
                      ? '输入完整的交易策略提示词...'
                      : '输入额外的交易策略提示...'
        ...
        {/* Footer */}
        <div className="flex justify-end gap-3 p-6 border-t border-[#E0E0E0] bg-[#F5F5F5]">
          <button
            onClick={onClose}
            className="px-6 py-3 bg-[#2B3139] text-[#EAECEF] rounded-lg hover:bg-[#404750] transition-all duration-200 border border-[#474D57]"
          >
            取消
          </button>
          {onSave && (
            <button
              ...
              className="px-8 py-3 bg-gradient-to-r from-[#E50012] to-[#C40010] text-white rounded-lg hover:from-[#C40010] hover:to-[#A30010] transition-all duration-200 disabled:bg-[var(--text-secondary)] disabled:cursor-not-allowed font-medium shadow-lg"
            >
