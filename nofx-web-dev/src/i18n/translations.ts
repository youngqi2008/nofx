...
export const translations = {
  en: {
    ...
    // Footer
    footerTitle: '智慧云数 - AI Trading System',
    ...
    hyperliquidAgentWalletTitle: 'Agent Wallet Configuration',
    hyperliquidAgentWalletDesc:
      'Hyperliquid uses an Agent wallet model. The Agent wallet (private key) handles all trades while the Main wallet controls permissions and fund transfers.',
    ...
    hyperliquidAgentPrivateKeyDesc:
      'The private key for the Agent wallet, used for trading authentication',
    ...
    hyperliquidMainWalletAddressDesc:
      'The Main wallet address that controls the Agent wallet permissions',
    ...
    heroTitle2: '交易未来。',
    heroDescription:
      '智慧云数 is an AI-powered agentic trading OS. Supporting Binance, Aster DEX and other exchanges, self-hosted, multi-agent competition, let AI automatically make decisions, execute and optimize trades for you.',
    poweredBy:
    ...
    startWithCrypto:
      'Starting with crypto markets, expanding to TradFi. 智慧云数 is the infrastructure of AgentFi.',
    ...
    whyChooseNofx: 'Why Choose 智慧云数?',
    openCommunityDriven:
      'Professional AI trading platform supporting multiple exchanges',
    openSourceSelfHosted: 'Multi-Exchange Coverage',
    openSourceDesc:
      'Support mainstream exchanges, manage all trades in one platform.',
    openSourceFeatures1: 'Binance Futures support',
    openSourceFeatures2: 'Hyperliquid integration',
    openSourceFeatures3: 'Aster DEX support',
    openSourceFeatures4: 'More exchanges coming soon',
    ...
    // About Section
    aboutNofx: 'About 智慧云数',
    whatIsNofx: 'What is 智慧云数?',
    nofxNotAnotherBot:
      "智慧云数 is not another trading bot, but the 'Linux' of AI trading —",
    nofxDescription1:
    ...
    howToStart: 'How to Get Started with 智慧云数',
    fourSimpleSteps:
      'Four simple steps to start your AI automated trading journey',
    step1Title: 'Create Account',
    step1Desc: 'Free registration, enter the new era of AI trading.',
    step2Title: 'Configure Strategy',
    step2Desc: 'Set trading parameters, risk preferences and AI models.',
    step3Title: 'Simulation Test',
    step3Desc: 'Test strategies in sandbox environment to ensure safety.',
    step4Title: 'Live Trading',
    step4Desc: 'Start live trading, let AI automatically profit for you.',
    importantRiskWarning: 'Important Risk Warning',
    riskWarningText:
      'Do not use funds you cannot afford to lose. 智慧云数 is non-custodial, no official strategies. Trading involves risks, invest carefully.',
    ...
    // Login Modal
    accessNofxPlatform: 'Access 智慧云数 Platform',
    loginRegisterPrompt:
    ...
    faqSubtitle: 'Find answers to common questions about 智慧云数',
    ...
    faqWhatIsNOFX: 'What is 智慧云数?',
    faqWhatIsNOFXAnswer:
      '智慧云数 is an AI-powered cryptocurrency trading bot that uses large language models (LLMs) to make trading decisions on futures markets.',
    ...
    faqIsProfitable: 'Is 智慧云数 profitable?',
    ...
    faqMultipleTradersAnswer:
      'Yes! 智慧云数 supports running multiple traders with different configurations, AI models, and trading strategies.',
    ...
    faqNeedCodingAnswer:
      'No! 智慧云数 has a web UI for all configuration. However, basic command line knowledge helps with setup and troubleshooting.',
    ...
    faqUseSubaccountAnswer:
      'Recommended: Yes, use a subaccount dedicated to 智慧云数 for better risk isolation. However, note that some subaccounts have restrictions (e.g., 5x max leverage on Binance).',
    ...
    faqHighFeesAnswer:
      '智慧云数 default 3-minute scan interval can cause frequent trading. Solutions: Increase decision interval to 5-10 minutes; Optimize system prompt to reduce overtrading; Adjust leverage to reduce position sizes.',
    ...
    faqDatabaseLockedAnswer:
      'Stop all processes with "docker compose down", then restart with "docker compose up -d".',
    ...
    faqAiLearningAnswer:
      'Yes, to some extent. 智慧云数 provides historical performance feedback in each decision prompt, allowing the AI to adjust its strategy.',
    ...
    faqGetHelpAnswer: 'Join our Telegram Community for help.',
  ...
  zh: {
    ...
    hyperliquidAgentWalletTitle: 'Agent 钱包配置',
    hyperliquidAgentWalletDesc:
      'Hyperliquid 使用 Agent 钱包模型。Agent 钱包（私钥）负责执行所有交易，而主钱包负责管理权限和资金划转。',
    hyperliquidAgentPrivateKey: 'Agent 私钥',
    enterHyperliquidAgentPrivateKey: '输入 Agent 私钥',
    hyperliquidAgentPrivateKeyDesc: 'Agent 钱包的私钥，用于交易认证',
    hyperliquidMainWalletAddress: '主钱包地址',
    enterHyperliquidMainWalletAddress: '输入主钱包地址',
    hyperliquidMainWalletAddressDesc: '控制 Agent 钱包权限的主钱包地址',
    ...
    heroTitle2: '交易未来。',
    heroDescription:
      '智慧云数 是 AI 驱动的代理式交易操作系统。支持 Binance、Aster DEX 等交易所，自托管、多代理竞争，让 AI 为你自动决策、执行和优化交易。',
    poweredBy: '由 Aster DEX 和 Binance 提供支持，Amber.ac 战略投资。',

    // Landing Page CTA
    readyToDefine: '准备好定义 AI 交易的未来吗？',
    startWithCrypto:
      '从加密市场起步，扩展到 TradFi。智慧云数 是 AgentFi 的基础架构。',
    getStartedNow: '立即开始',
    ...
    // Features Section
    coreFeatures: '核心功能',
    whyChooseNofx: '为什么选择智慧云数？',
    openCommunityDriven: '专业的 AI 交易平台，支持多个主流交易所',
    openSourceSelfHosted: '多交易所全覆盖',
    openSourceDesc: '支持主流交易所，一站式管理所有交易。',
    openSourceFeatures1: '支持币安期货',
    openSourceFeatures2: '集成 Hyperliquid',
    openSourceFeatures3: '支持 Aster DEX',
    openSourceFeatures4: '更多交易所持续接入',
    ...
    whatIsNofx: '什么是智慧云数？',
    nofxNotAnotherBot:
      "智慧云数 不是另一个交易机器人，而是 AI 交易的 'Linux' ——",
    ...
    // How It Works Section
    howToStart: '如何开始使用智慧云数',
    fourSimpleSteps: '四个简单步骤，开启 AI 自动交易之旅',
    step1Title: '创建账户',
    step1Desc: '免费注册，进入 AI 交易新时代。',
    step2Title: '配置策略',
    step2Desc: '设置交易参数、风险偏好和 AI 模型。',
    step3Title: '模拟测试',
    step3Desc: '沙盒环境测试策略，确保安全。',
    step4Title: '实盘交易',
    step4Desc: '启动实盘交易， AI 为您自动盈利。',
    importantRiskWarning: '重要风险提示',
    riskWarningText:
      '勿用无法承受损失的资金。智慧云数 非托管，无官方策略。交易有风险，投资需谨慎。',
    ...
    faqNeedCodingAnswer:
      '不需要！智慧云数 有 Web 界面进行所有配置。但基础的命令行知识有助于安装和故障排查。',
    ...
    faqUseSubaccountAnswer:
      '推荐：是的，使用专门的子账户运行智慧云数可以更好地隔离风险。但请注意，某些子账户有限制（例如币安子账户最高 5 倍杠杆）。',
    ...
    faqHighFees: '交易手续费太高',
    faqHighFeesAnswer:
      '智慧云数 默认 3 分钟扫描间隔会导致频繁交易。解决方案：将决策间隔增加到 5-10 分钟；优化系统提示词减少过度交易；调整杠杆降低仓位大小。',
    ...
    faqDatabaseLockedAnswer:
      '使用 "docker compose down" 停止所有进程，然后使用 "docker compose up -d" 重启。',
    ...
    faqAiLearningAnswer:
      '会的，在一定程度上。智慧云数 在每次决策提示中提供历史表现反馈，允许 AI 调整策略。',
    ...
    faqGetHelpAnswer: '加入 Telegram 社区获取帮助。',
