...
export const translations = {
  en: {
    ...
    heroDescription:
      'Ares is the future standard for AI trading — a professional agentic trading OS. Supporting Binance, Aster DEX and other exchanges, self-hosted, multi-agent competition, let AI automatically make decisions, execute and optimize trades for you.',
    poweredBy:
    ...
    whyChooseAres: 'Why Choose Ares?',
    openCommunityDriven:
      'Professional, transparent, enterprise-grade AI trading OS',
    ...
    // About Section
    aboutAres: 'About Ares',
    whatIsAres: 'What is Ares?',
    aresNotAnotherBot:
      "Ares is not another trading bot, but the 'Linux' of AI trading —",
    aresDescription1:
    ...
    step1Desc:
      'Download and setup Ares platform, configure your environment for automated trading.',
    ...
    step4Desc:
      'Monitor trading performance in real-time, analyze results, and optimize your AI trading strategies.',
    ...
    // Login Modal
    accessAresPlatform: 'Access Ares Platform',
    loginRegisterPrompt:
  ...
  zh: {
    ...
    heroTitle2: 'Write the Trade.',
    heroDescription:
      'Ares 是 AI 交易的未来标准——一个专业的代理式交易操作系统。支持 Binance、Aster DEX 等交易所，自托管、多代理竞争，让 AI 为你自动决策、执行和优化交易。',
    ...
    // Features Section
    coreFeatures: '核心功能',
    whyChooseAres: '为什么选择 Ares？',
    openCommunityDriven: '专业、透明、企业级的 AI 交易操作系统',
    ...
    aboutAres: '关于 Ares',
    whatIsAres: '什么是 Ares？',
    aresNotAnotherBot: "Ares 不是另一个交易机器人，而是 AI 交易的 'Linux' ——",
    aresDescription1: "一个透明、可信任的开源 OS，提供统一的 '决策-风险-执行'",
    aresDescription2: '层，支持所有资产类别。',
    aresDescription3:
      '从加密市场起步（24/7、高波动性完美测试场），未来扩展到股票、期货、外汇。核心：开放架构、AI',
    aresDescription4:
      '达尔文主义（多代理自竞争、策略进化）、CodeFi 飞轮（开发者 PR',
    aresDescription5: '贡献获积分奖励）。',
    ...
    step4Title: '监控与优化',
    step4Desc: '实时监控交易表现，分析结果，优化您的 AI 交易策略。',
