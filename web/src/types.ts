...
export interface CoinSourceConfig {
  ...
  use_oi_top: boolean;
  oi_top_limit?: number;
  // Note: API URLs are now built automatically using aresos_api_key from IndicatorConfig
}
...
export interface IndicatorConfig {
  ...
  // ========== AresOS 数据源统一配置 ==========
  // Unified AresOS API Key - used for all AresOS data sources
  aresos_api_key?: string;
