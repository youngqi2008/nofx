        ...
        <div className="text-center max-w-md mx-auto px-6">
          ...
          <button
            ...
            style={{
              ...
              boxShadow: '0 4px 12px rgba(229, 0, 18, 0.3)',
            }}
          >
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, rgba(229, 0, 18, 0.15) 0%, rgba(255, 26, 46, 0.05) 100%)',
          border: '1px solid rgba(229, 0, 18, 0.2)',
          boxShadow: '0 0 30px rgba(229, 0, 18, 0.15)',
        }}
      >
        <div className="flex items-start justify-between mb-3">
          ...
          >
            ...
            >
              <Bot className="w-5 h-5" style={{ color: 'var(--brand-white)' }} />
            </span>
                      ...
                      >
                        ...
                        <td className="py-3 font-mono">
                          <span
                            style={{
                              color:
                                pos.unrealized_pnl >= 0 ? 'var(--binance-green)' : 'var(--binance-red)',
                              fontWeight: 'bold',
                            }}
                          >
...
function StatCard({
  ...
  return (
    <div className="stat-card animate-fade-in">
      ...
      {change !== undefined && (
        <div className="flex items-center gap-1">
          <div
            ...
            style={{ color: positive ? 'var(--binance-green)' : 'var(--binance-red)' }}
          >
            {positive ? '▲' : '▼'} {positive ? '+' : ''}
            {change.toFixed(2)}%
          </div>
      ...
      {subtitle && (
        <div className="text-xs mt-2 mono" style={{ color: 'var(--text-secondary)' }}>
          {subtitle}
        </div>
      )}
    </div>
    ...
    >
        ...
        <div className="space-y-2 mb-3">
          {decision.decisions.map((action, j) => (
            ...
            >
              ...
              {action.leverage > 0 && (
                <span style={{ color: 'var(--accent-red)' }}>{action.leverage}x</span>
              )}
              {action.price > 0 && (
                <span
              ...
              <span style={{ color: action.success ? 'var(--binance-green)' : 'var(--binance-red)' }}>
                {action.success ? (
              ...
              {action.error && (
                <span className="text-xs ml-2" style={{ color: 'var(--binance-red)' }}>
                  {action.error}
                </span>
              )}
            </div>
      ...
      {decision.error_message && (
        <div
          ...
          style={{ color: 'var(--binance-red)', background: 'var(--binance-red-bg)' }}
        >
